...
export function useSubmitContactForm() {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      if (data.productInterest === 'life-insurance' || data.productInterest === 'lifeInsurance') {
        ...
        throw new Error(`Invalid product interest value: ${data.productInterest}`);
      }
      ...
      const coverageAmountBigInt = coverageAmountStr ? BigInt(coverageAmountStr) : BigInt(0);
