                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="sms:239-331-0544" className="text-accent-blue hover:text-navy transition-colors">
                        239-331-0544
                      </a>
                      <p className="text-muted-foreground text-sm">Text anytime</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:jonathanayan.eip@gmail.com" className="text-accent-blue hover:text-navy transition-colors">
