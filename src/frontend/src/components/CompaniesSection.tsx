      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            As an independent broker, I work with all the top-rated insurance
            companies in the country. This means I can shop the market to find
            you the best rates and coverage options, without being limited to a
            ...
            <CardContent className="p-8">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-accent-blue mt-2 mr-3 flex-shrink-0" />
                  <span className="text-foreground/80">
                    <strong className="text-navy">Best Rates:</strong> I compare
                    quotes from multiple carriers to find you the lowest price
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-accent-blue mt-2 mr-3 flex-shrink-0" />
                  <span className="text-foreground/80">
                    <strong className="text-navy">More Options:</strong> Access
                    to 30+ A+ rated carriers means more choices for your unique
                    needs
                  </span>
                </li>
              </ul>
